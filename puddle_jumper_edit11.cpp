// puddle_jumper_edit11.cpp : Defines the entry point for the console application.
//
...
public:
	// Constructor
	Airport(const string & code) : airport_code(code) {} // Only giving the constructor the airport code
	string airport_code;
